const contractAddress = "0xEf860825Da376505688ac70e37862936dc8c500b"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the Queens of Clubs NFT production!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Queens of Clubs is a project aimed to gather the like minded.';
const h1_presale_coming_soon = "First NFT Drop Coming Soon!";
const h1_presale_mint = "Sale Minting Open!";
